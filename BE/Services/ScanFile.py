...
# def extract_ahp_matrix_by_marker_safe(file_path: str, marker: str = "*"):
#     wb = load_workbook(file_path, data_only=False)  # <-- lấy luôn công thức
#     ws = wb.active
...
#             # ✅ Nếu là float/int thì dùng luôn
#             if isinstance(val, (float, int)):
#                 row_data.append(float(val))
#             # ✅ Nếu là công thức dạng =1/B5 → tự tính
#             elif isinstance(val, str) and val.startswith("=1/"):
#                 ref = val[3:]  # bỏ "=1/"
#                 try:
#                     ref_val = ws[ref].value
#                     if isinstance(ref_val, (float, int)) and ref_val != 0:
...
#                     row_data.append(0.0)
#             else:
#                 row_data.append(0.0)  # fallback an toàn
...
# criteria, matrix = extract_ahp_matrix_by_marker_safe(r"D:\AHP_DoAn\AHP.xlsx", "*")

# print("Tiêu chí:", criteria)
# print("Ma trận AHP:")
# for row in matrix:
#     print(row)
